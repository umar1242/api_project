...
export class CreateMaterialDto {
  ...
  @ApiPropertyOptional({ description: 'Optional lesson ID if tied to a specific lesson' })
  @IsOptional()
  @IsNumber()
  lessonId?: number;
  ...
  @ApiPropertyOptional({ description: 'Telegram file ID for native bot delivery' })
  @IsOptional()
  @IsString()
  telegramFileId?: string;

  @ApiPropertyOptional({ enum: MaterialStatus, default: MaterialStatus.PENDING })
  @IsOptional()
  @IsEnum(MaterialStatus)
  status?: MaterialStatus;

  @ApiPropertyOptional({ description: 'ISO date string when the material should be published' })
  @IsOptional()
  @IsDateString()
  publishAt?: string;
}
